...
class MainTabBarController: UITabBarController {
    ...
    func setupCustomTabBar() {
        ...
        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedString.Key.font: UIFont.roboto(ofSize: Metrics.fontSizeMedium,
                                                                                                     weight: .light),
                                                          NSAttributedString.Key.foregroundColor: UIColor.gray500], for: .normal)
        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedString.Key.font: UIFont.roboto(ofSize: Metrics.fontSizeMedium,
                                                                                                     weight: .light),
                                                          NSAttributedString.Key.foregroundColor: UIColor.sky100], for: .selected)
    }
}
