...
extension UIImage {
    ...
    public class var systemChevronDownIcon: UIImage {
        return initializeSystemImage(with: "chevron.down")
    }
    
    public class var systemChevronUpIcon: UIImage {
        return initializeSystemImage(with: "chevron.up")
    }
